...
export const getCategoryTransactions=async(data)=>await API.get(`/transaction/category/${data.category}`)
// Recurring Payments
...
export const getLimit = async()=>await API.get('/limits')
export const setLimit = async(data)=>await API.post('/limits',data)
export const deleteLimit = async(data)=>await API.delete('/limits',{data:data})
